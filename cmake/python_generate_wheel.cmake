...
set(PYTHON_PROJECT pymars2grib)
...
configure_file(
  ${PROJECT_SOURCE_DIR}/src/pyencode_mtg2/setup.py.in
...
add_custom_command(
  ...
  COMMAND ${CMAKE_COMMAND} -E make_directory ${PYTHON_PROJECT}/lib
  ...
  # ${PYTHON_PROJECT}/lib
  COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:pyencode_mtg2> ${PYTHON_PROJECT}/lib/
  COMMAND ${Python3_EXECUTABLE} -m build
  COMMAND ${CMAKE_COMMAND} -E touch ${PROJECT_BINARY_DIR}/python/dist/timestamp
  MAIN_DEPENDENCY
    src/pyencode_mtg2/setup.py.in
  DEPENDS
    src/pyencode_mtg2/setup.py
    # ${PROJECT_NAMESPACE}::pyencode_mtg2
    pyencode_mtg2
  BYPRODUCTS
