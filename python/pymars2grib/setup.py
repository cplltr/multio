...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        files = glob.glob(str(build_temp) + "/lib/pymars2grib_bindings*.so")
        files += glob.glob(str(build_temp) + "/lib/pymars2grib_bindings*.dylib")
        destination = extdir / "pymars2grib"
...
setup(
    name="pymars2grib",
    version=version,
    description="mars2grib mapping to encode data in GRIB2 with MARS keys",
    ext_modules=[CMakeExtension("pymars2grib_bindings", sourcedir="../../..")],
